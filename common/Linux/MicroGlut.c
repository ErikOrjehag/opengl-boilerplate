...
ERROR !This is NOT the Mac version of MicroGlut and will not work on the Mac !
    ...
    static unsigned int winWidth = 300,
                        winHeight = 300;
...
void glutIdleFunc(void (*func)(void)) { gIdle = func; }
...
void glutMouseFunc(void (*func)(int button, int state, int x, int y)) { gMouseFunc = func; }
void glutMotionFunc(void (*func)(int x, int y)) { gMouseDragged = func; }
void glutPassiveMotionFunc(void (*func)(int x, int y)) { gMouseMoved = func; }
...
void doKeyboardEvent(XEvent event, void (*keyProc)(unsigned char key, int x, int y), void (*specialKeyProc)(unsigned char key, int x, int y), int keyMapValue) {
    ...
    switch (code) {
        case 111:
            buffer[0] = GLUT_KEY_UP;
            break;
        case 114:
            buffer[0] = GLUT_KEY_RIGHT;
            break;
        case 116:
            buffer[0] = GLUT_KEY_DOWN;
            break;
        case 113:
            buffer[0] = GLUT_KEY_LEFT;
            break;
        case 67:
            buffer[0] = GLUT_KEY_F1;
            break;
        case 68:
            buffer[0] = GLUT_KEY_F2;
            break;
        case 69:
            buffer[0] = GLUT_KEY_F3;
            break;
        case 70:
            buffer[0] = GLUT_KEY_F4;
            break;
        case 71:
            buffer[0] = GLUT_KEY_F5;
            break;
        case 72:
            buffer[0] = GLUT_KEY_F6;
            break;
        case 73:
            buffer[0] = GLUT_KEY_F7;
            break;
        case 112:
            buffer[0] = GLUT_KEY_PAGE_UP;
            break;
        case 117:
            buffer[0] = GLUT_KEY_PAGE_DOWN;
            break;
        case 110:
            buffer[0] = GLUT_KEY_HOME;
            break;
        case 115:
            buffer[0] = GLUT_KEY_END;
            break;
        case 118:
            buffer[0] = GLUT_KEY_INSERT;
            break;

        case 50:
            buffer[0] = GLUT_KEY_LEFT_SHIFT;
            break;
        case 62:
            buffer[0] = GLUT_KEY_RIGHT_SHIFT;
            break;
        case 37:
        case 105:
            buffer[0] = GLUT_KEY_CONTROL;
            break;
        case 64:
        case 108:
            buffer[0] = GLUT_KEY_ALT;
            break;
        case 133:
        case 134:
            buffer[0] = GLUT_KEY_COMMAND;
            break;
        ...
        while (XPending(dpy) > 0) {
            ...
            switch (event.type) {
                ...
                case ConfigureNotify:
                    ...
                    break;
                case KeyPress:
                    doKeyboardEvent(event, gKey, gSpecialKey, 1);
                    break;
                case KeyRelease:
                    doKeyboardEvent(event, gKeyUp, gSpecialKeyUp, 0);
                    break;
                case ButtonPress:
                    ...
                    if (gMouseFunc != NULL)
                        switch (event.xbutton.button) {
                            case Button1:
                                ...
                                break;
                            case Button2:
                                gMouseFunc(GLUT_MIDDLE_BUTTON, GLUT_DOWN, event.xbutton.x, event.xbutton.y);
                                break;
                            case Button3:
                                gMouseFunc(GLUT_RIGHT_BUTTON, GLUT_DOWN, event.xbutton.x, event.xbutton.y);
                                break;
                        }
                    break;
                case ButtonRelease:
                    ...
                    if (gMouseFunc != NULL)
                        switch (event.xbutton.button) {
                            case Button1:
                                ...
                                break;
                            case Button2:
                                gMouseFunc(GLUT_MIDDLE_BUTTON, GLUT_UP, event.xbutton.x, event.xbutton.y);
                                break;
                            case Button3:
                                gMouseFunc(GLUT_RIGHT_BUTTON, GLUT_UP, event.xbutton.x, event.xbutton.y);
                                break;
                        }
                    break;
                case MotionNotify:
