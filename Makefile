...
all: $(BUILD_DIR)main.o $(BUILD_DIR)FrameBuffer.o $(BUILD_DIR)Camera.o $(BUILD_DIR)Skybox.o $(BUILD_DIR)Terrain.o $(BUILD_DIR)Water.o $(BUILD_DIR)Object.o $(COMMON_OFILES)
